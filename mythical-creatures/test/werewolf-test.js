...
describe('Werewolf', function() {
  ...
  it('should show assert wolf form after change', function() {
    ...
    //create a key of wolf
    //calling the change()
    //statements need to be inside change()
  });
  ...
  it('should be able to eat(victim) once hungry', function() {
    // your code here
        var werewolf = new Werewolf('Black Dynamite', 'Florida');
        var victim = new Victim('Turtle');
        werewolf.change();
        assert.equal(werewolf.hungry, true);
  ...
  it('should not be hungry after changing back to human form', function() {
    // your code here
    var werewolf = new Werewolf('Edward', 'Chicago');
    werewolf.change();
    werewolf.change();
    assert.equal(werewolf.hungry, false);
  });
  ...
  it('should change back to human form after eating', function() {
    // your code here
    var werewolf = new Werewolf('Bella', 'Chicago');
    var victim = new Victim('Turtle');
    werewolf.change();
    assert.equal(werewolf.hungry, true);
    assert.equal(victim.alive, true);
